...
public enum StatType {
    ...
    LIFE_STEAL("Life Steal", "([+-]\\d+)/\\ds Life Steal", "life steal", "ls"),
    MANA_REGEN("Mana Regen", "([+-]\\d+)/\\ds Mana Regen", "mana regen", "mr"),
    MANA_STEAL("Mana Steal", "([+-]\\d+)/\\ds Mana Steal", "mana steal", "ms"),
    ...
    POISON("Poison", "([+-]\\d+)/\\ds Poison", "poison", "poison damage"),
